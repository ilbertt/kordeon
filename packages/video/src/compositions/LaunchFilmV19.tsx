...
// Cut 19 — cut 17's timeline (no separate closing beat), but the ownership line now
// lands inside the finale: as the window recomposes into the mark, "Self-hostable.
// Bring your own agents." rises over the fold and clears before the white lockup
// tile appears. The finale's floating "Self-hostable." label stays dropped.
export const filmV19Schema = filmV12Schema.extend({
  selfHostSubtitle: z.string(),
});

export const filmV19DefaultProps: z.infer<typeof filmV19Schema> = {
  ...filmV17DefaultProps,
  // Empty so the finale drops its floating label; the point is the fold caption.
  selfHost: '',
...
export const FILM_V19_DURATION = BEATS_TOTAL - (ORDER.length - 1) * CROSSFADE_FRAMES;
...
export function LaunchFilmV19(props: z.infer<typeof filmV19Schema>) {
  return (
