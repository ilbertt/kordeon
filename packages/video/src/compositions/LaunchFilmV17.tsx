...
// Cut 17 — cut 16, plus a gentle camera move on the establishing shot: while the
// caption says every channel is a thread for a piece of work, the slab eases into
// the left channel-list panel and cranes slowly down it (then pulls back to wide so
// the crossfades still meet on the shared wide slab). Copy is unchanged from cut 16.
export const filmV17Schema = filmV12Schema;

export const filmV17DefaultProps: z.infer<typeof filmV17Schema> = {
  ...filmV16DefaultProps,
};
...
export const FILM_V17_DURATION = BEATS_TOTAL - (ORDER.length - 1) * CROSSFADE_FRAMES;
...
export function LaunchFilmV17(props: z.infer<typeof filmV17Schema>) {
  return (
