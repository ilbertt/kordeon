...
export function KineticCaption({
  ...
  // Push the text down from its natural (centred / lower-third) position — e.g. so a
  // hero line can sit *below* a logo sharing the frame.
  offsetY?: number;
}) {
  ...
  return (
    ...
    >
      <div
        ...
        style={{ opacity, translate: `0 ${rise + offsetY}px` }}
      >
