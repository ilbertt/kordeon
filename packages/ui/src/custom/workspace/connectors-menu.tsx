...
// Gmail and Slack keep their brand colors; the monochrome coming-soon marks ride
// `currentColor` so they read in both themes and grey out cleanly when disabled.
// Coming-soon paths are the canonical Simple Icons marks. GitHub's mark is shared
// (@repo/ui/custom/github-icon), since the site header and preview use it too.
function GmailIcon() {
  return (
