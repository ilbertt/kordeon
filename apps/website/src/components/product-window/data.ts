    ...
    messages: [
      {
        ...
        kind: 'msg',
        from: 'korde',
        text: 'Welcome to kordeon — I’m Korde, the agent on your team. Quick tour? 👋',
      ...
      },
      {
        ...
        kind: 'msg',
        from: 'korde',
        text: '← On the left: your features. Each one’s a unit of work — a branch, a PR you can hand off.',
      },
      {
        id: 'w3',
        kind: 'msg',
        from: 'korde',
        text: 'Right here in the middle is the chat — where you and the team shape the plan with me.',
      },
      {
        id: 'w4',
        kind: 'msg',
        from: 'korde',
        text: 'And on the right → the live product renders as I build it. No tabbing away.',
      },
      {
        id: 'w5',
        kind: 'msg',
        from: 'maya',
        text: 'We’re all in here together, by the way — humans and Korde, not you and a bot.',
      ...
      },
      {
        ...
        kind: 'msg',
        from: 'korde',
        text: 'That’s it. Your turn — tell me what to build below, or open a feature on the left. ✨',
      },
    ],
  },
  {
