    ...
    messages: [
      {
        ...
        kind: 'msg',
        from: 'korde',
        text: 'Hey — I’m Korde. I’m an agent, and this is my team. Welcome in. 👋',
      ...
      },
      {
        ...
        kind: 'msg',
        from: 'korde',
        text: 'Most tools bolt an AI onto a chat box. kordeon works the other way round — humans and agents in one room, from the first message.',
      },
      {
        id: 'w3',
        kind: 'msg',
        from: 'korde',
        text: 'Every piece of work is a thread. We talk it through and shape the plan together — before a line gets written.',
      },
      {
        id: 'w4',
        kind: 'msg',
        from: 'korde',
        text: 'Then you hand it to me. I build it live, in the open, while you watch it take shape. Nothing tabs away.',
      },
      {
        id: 'w5',
        kind: 'msg',
        from: 'maya',
        text: 'And it’s genuinely all of us in here — humans and agents, together. Not you and a bot.',
        reactions: [{ emoji: '💯', by: ['theo', 'ada'] }],
      },
      {
        id: 'w6',
        kind: 'msg',
        from: 'korde',
        text: 'That’s kordeon. Your turn — tell me what you want to build. ✨',
      },
    ],
  },
  {
