    ...
    messages: [
      {
        ...
        kind: 'msg',
        from: 'maya',
        text: 'Let’s build an analytics dashboard for our product — I want to see how new signups are actually converting.',
      },
      {
        id: 'c2',
        kind: 'msg',
        from: 'theo',
        text: 'Two charts to start: signups by week, and activation rate by channel so we can see where paid’s lagging.',
      ...
      },
      {
        ...
        kind: 'msg',
        from: 'korde',
        text: 'Got it — an activation dashboard: a signups-by-week trend and activation by channel, live from the warehouse. Here’s a plan — edit any step, reorder, or add your own before we start.',
        plan: [
          { id: 'w', label: 'Connect the warehouse + define the metrics', done: false },
          { id: 't', label: 'Signups by week, with the quarter-over-quarter trend', done: false },
      ...
      },
      {
        ...
        kind: 'msg',
        from: 'theo',
        text: 'And let’s chart signups first — the weekly trend gives the channel rates their context.',
      },
    ],
  },
  {
